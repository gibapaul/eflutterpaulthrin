import 'package:eshopping/screens/welcome_screen.dart';
import 'package:eshopping/theme/theme.dart';
import 'package:eshopping/widgets/gradient_button.dart';
...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  final List<OnboardingData> _pages = [
    OnboardingData(
      ...
      description:
          "Explore our vast collection of trendy and fashionablen items curvated just for you",
      image: "assets/images/onboarding1.png",
    ),
    OnboardingData(
      title: "Paul Shopping Experience",
      description:
